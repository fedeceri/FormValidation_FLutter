//Archivo encargado de hacer las interacciones directas con la BD
...
class ProductosProvider {
  final String _url = 'https://flutter-varios-39305.firebaseio.com';
  final _prefs = new PreferenciasUsuario();


  Future<bool> crearProducto(ProductoModel producto) async {
    //url del POST para insertar nuevo registro
  ...
  Future<List<ProductoModel>> cargarProductos() async {
    ...
    //TODO cambiar para que retorne un mensaje de error
  ...
  Future<String> subirImagen(File imagen) async {
    final url = Uri.parse('https://api.cloudinary.com/v1_1/dlktex3ei/image/upload?upload_preset=m3dcs3vm');
